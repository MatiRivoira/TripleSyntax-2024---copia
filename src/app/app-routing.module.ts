...
const routes: Routes = [
  ...
  {
    path: 'graficos2',
    loadChildren: () => import('./paginas/graficos2/graficos2.module').then( m => m.Graficos2PageModule)
  },
  {
    path: 'redirigir-home',
    loadChildren: () => import('./paginas/redirigir-home/redirigir-home.module').then( m => m.RedirigirHomePageModule)
  }
